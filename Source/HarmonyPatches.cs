...
namespace DismissLetters
{
    ...
    public static class HarmonyPatches
    {
        ...
        {
            harmony.Patch(typeof(LetterStack).GetMethod(nameof(LetterStack.ReceiveLetter), new Type[] { typeof(Letter), typeof(string) }), postfix: new HarmonyMethod(typeof(LetterManager), nameof(LetterManager.AddLetter)));
